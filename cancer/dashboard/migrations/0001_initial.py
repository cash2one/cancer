    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.CharField(max_length=200, blank=True)),
                ...
                ('updated_by', models.ManyToManyField(related_name='cancer_updated', to=settings.AUTH_USER_MODEL, blank=True)),
            ],
        ),
        migrations.CreateModel(
            name='FollowUp',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DOD', models.CharField(max_length=200, null=True, blank=True)),
                ('relative', models.IntegerField(blank=True, null=True, choices=[(1, b'\xe7\x88\xb6\xe6\xaf\x8d'), (2, b'\xe9\x85\x8d\xe5\x81\xb6'), (3, b'\xe5\xad\x90\xe5\xa5\xb3'), (4, b'\xe5\x85\xb6\xe4\xbb\x96')])),
                ...
                ('relative_in_contact', models.IntegerField(blank=True, null=True, choices=[(1, b'\xe6\x98\xaf'), (2, b'\xe4\xb8\x8d\xe6\x98\xaf')])),
                ('tagged', models.NullBooleanField()),
                ('comment', models.CharField(max_length=200, null=True, blank=True)),
                ('created_date', models.DateTimeField(default=datetime.datetime.now, verbose_name=b'Created Date', blank=True)),
                ('updated_date', models.DateTimeField(auto_now=True, verbose_name=b'Updated date', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(related_name='questionnaires', to='dashboard.Patient', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(related_name='tests', to='dashboard.Patient', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(related_name='treatments', to='dashboard.Patient', null=True)),
        ...
        migrations.AddField(
            model_name='followup',
            name='patient',
            field=models.ForeignKey(related_name='followups', to='dashboard.Patient', null=True),
        ),
        migrations.AddField(
            model_name='followup',
            name='updated_by',
