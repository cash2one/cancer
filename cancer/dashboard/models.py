...
class Patient(models.Model):
	...
	#INCOMPLETE FIELDS
	relative = models.IntegerField(choices=PATIENT_RELATIVE_CHOICES, null=True,blank=True,)  #关系（1 父母，2 配偶，3 子女，4 其它）
	...
	relative_in_contact = models.IntegerField(choices = PATIENT_IN_CONTACT_CHOICES,null=True,blank=True,)
...
class Cancer(models.Model):
	patient = models.CharField(max_length=200,blank=True) # models.ForeignKey(Patient, null=True,related_name='cancers') TODO
	DB_ID = models.CharField(max_length=200,blank=True) #, unique=True) TODO
	name = models.CharField(max_length=200,blank=True, null=True)
	EMR_id = models.CharField(max_length=200,blank=True,null=True)
